...
function ManData(x, y, box) {
	...
	this.walk_flag = [
		[new Point(20,60),new Point(10,75),new Point(17,65),new Point(13,71)],//一隻腳的端點和控制的基準點
		[new Point(20,60),new Point(30,75),new Point(23,64),new Point(27,70)],//另一隻腳的端點和控制的基準點
		[
...
ManData.prototype.start_walk = function () {//只是腳部有動作
	//第二端點
	...
	var part_1 = part+100;
	var temp_man = this;
	this.walking_func = setInterval(frame, 10);
	function frame() {
		if (false/*part == 200*/) {
			//clearInterval(id);
		} else {
...
ManData.prototype.draw = function () {//將各種東西（多型）畫到螢幕上
